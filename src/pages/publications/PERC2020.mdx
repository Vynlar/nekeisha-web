import { Text, Accordion, AccordionItem, AccordionHeader, AccordionIcon, AccordionPanel, Image } from '@chakra-ui/core';
...
<Image borderRadius="9%" src={matrix} mx='auto' my='10' />

### Examining consistency of student errors in vector operations using module analysis

<Text fontSize='lg'>
    Nekeisha Johnson, John B. Buncher
</Text>

<Text color='gray.500'>North Dakota State University</Text>
...
<Image src={exampleQuestion} mx='auto' maxW='sm' mt='4' />
...
<Image src={percentCorrect} mx='auto' maxW='xl' mt='4' />
