...
<Flex direction={['column', 'row']} mt='4' spacing='4'>
    <Box bg='gray.50' py='4' px='6' borderRadius='md' border='1px' borderColor='gray.200' mb={[4, 0]} mr={[0, 4]}>
        <Text fontWeight='bold' color='teal.500'>Nekeisha Johnson</Text>
        <Text>nekeisha.johnson@ndsu.edu</Text>
    </Box>
    <Box bg='gray.50' py='4' px='6' borderRadius='md' border='1px' borderColor='gray.200'>
