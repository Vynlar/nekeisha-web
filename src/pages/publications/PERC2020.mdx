import { Flex, PseudoBox, Box, Text, Accordion, AccordionItem, AccordionHeader, AccordionIcon, AccordionPanel, Image } from '@chakra-ui/core';
...
<Flex direction={['column', 'row']} mt='4' spacing='4'>
    <PseudoBox as='a' href='mailto:nekeisha.johnson@ndsu.edu' _hover={{ bg: 'teal.50', borderColor: 'teal.200' }} bg='gray.50' py='4' px='6' borderRadius='md' border='1px' borderColor='gray.200' mb={[4, 0]} mr={[0, 4]}>
        <Text fontWeight='bold' color='teal.500'>Nekeisha Johnson</Text>
        <Text>nekeisha.johnson@ndsu.edu</Text>
    </PseudoBox>
    <PseudoBox as='a' href='mailto:john.buncher@ndsu.edu' _hover={{ bg: 'teal.50', borderColor: 'teal.200' }} bg='gray.50' py='4' px='6' borderRadius='md' border='1px' borderColor='gray.200' mb={[4, 0]} mr={[0, 4]}>
